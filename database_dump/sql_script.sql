...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ project_datamodels /*!40100 DEFAULT CHARACTER SET latin1 */;

USE project_datamodels;

/*Table structure for table `offices`*/

/*Table structure for table 'customers'*/

DROP TABLE IF EXISTS project_datamodels.customers;

CREATE TABLE project_datamodels.customers (
...
insert into project_datamodels.customers  
...
DROP TABLE IF EXISTS project_datamodels.employees;

CREATE TABLE project_datamodels.employees (
...
insert into project_datamodels.employees
...
DROP TABLE IF EXISTS project_datamodels.offices;

CREATE TABLE project_datamodels.offices (
    `officeCode` varchar(10) NOT NULL,
    `city` varchar(50) NOT NULL,
    `phone` varchar(50) NOT NULL,
    `addressLine1` varchar(50) NOT NULL,
...
insert into project_datamodels.offices 
...
DROP TABLE IF EXISTS project_datamodels.orderdetails;

CREATE TABLE project_datamodels.orderdetails (
...
insert into project_datamodels.orderdetails 
...
DROP TABLE IF EXISTS project_datamodels.orders;

CREATE TABLE project_datamodels.orders (
    `orderNumber` int NOT NULL,
...
insert into project_datamodels.orders
...
DROP TABLE IF EXISTS project_datamodels.payments;

CREATE TABLE project_datamodels.payments (
    customerNumber int NOT NULL,
...
insert into project_datamodels.payments
...
DROP TABLE IF EXISTS project_datamodels.productlines;

CREATE TABLE project_datamodels.productlines (
...
insert into project_datamodels.productlines 
...
DROP TABLE IF EXISTS project_datamodels.products;

CREATE TABLE project_datamodels.products (
    `productCode` varchar(15) NOT NULL,
...
insert into project_datamodels.products
